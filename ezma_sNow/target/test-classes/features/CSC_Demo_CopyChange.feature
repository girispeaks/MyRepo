...
Scenario: Copy Change scenario
       ...
       Then I wait for "5" seconds
       Then I switch to frame "gsft_main"
       Then I enter "short desc for copy change" into "ShortDesc" text field
       Then I wait for "2" seconds
       ...
       Then I enter "justification for copy change" into "Justification" text field
       ...
       Then I enter "Allianz" into "CompanyNameCopy" text field
       Then I wait for "3" seconds
       Then I enter "justification for new copy change" into "Justification" text field
       Then I click on "Scheduletab" button
       Then I enter future date in "PlannedStartDate" datepicker
       Then I save "PlannedStartDate" PlannedStartDate field value element
       Then I wait for "4" seconds
