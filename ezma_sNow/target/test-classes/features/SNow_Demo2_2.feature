...
Scenario: Conflicts 
       ...
       Then I increment "1" days in "PlannedStartDate" field
       Then I wait for "4" seconds
       Then I increment "1" days in "PlannedEndDate" field
    ...
    And I wait for "5" seconds
      ...
      Then I switch to frame "gsft_main"
       ...
       Then I wait for "4" seconds
       And I validate "Not In Maintenance Window" value exists in table
       And I validate "Inside blackout window" value exists in table
       And I validate "CI Already Scheduled" value exists in table
       ...
       #Then I validate if "Not In Maintenance Window" value exists as "ConflictType" field in table
     	#Then I validate if "Not In Maintenance Window" values exists in table
