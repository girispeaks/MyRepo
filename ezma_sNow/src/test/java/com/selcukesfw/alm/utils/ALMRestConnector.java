...
public class ALMRestConnector {
    ...
    protected ALMRestConnector init(
    ...
    protected static ALMRestConnector getInstance() {
        return instance;
    }
    /**
     * @param entityType
     * @return URL
     */
    protected String buildEntityCollectionUrl(String entityType) {
    ...
    protected Response httpPut(String url, byte[] data, Map<String, String> headers) throws Exception {
        return doHttp("PUT", url, null, data, headers, cookies);
    }
    protected Response httpPost(String url, byte[] data, Map<String, String> headers) throws Exception {
        return doHttp("POST", url, null, data, headers, cookies);
    }
    protected Response httpDelete(String url, Map<String, String> headers) throws Exception {
        return doHttp("DELETE", url, null, null, headers, cookies);
    }
    protected Response httpGet(String url, String queryString, Map<String, String> headers)
            throws Exception {
